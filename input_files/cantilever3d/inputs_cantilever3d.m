...
FE.mesh_input.box_dimensions = [20 10 10]; % ***
FE.mesh_input.elements_per_side = [80 40 40]; % ***
...
%% Boundary conditions
    ...
    FE.mesh_input.bcs_file = 'input_files/cantilever3d/setup_bcs_cantilever3d.m';
...
%% Initial design (geometry)
    ...
    GEOM.initial_design.path = 'input_files/cantilever3d/initial_geometry_cantilever3d.m';
...
% functions:
    ...
    OPT.functions.constraint_limit = [0.1]; % ***
